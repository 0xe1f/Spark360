...
public class PsnFriendListItem
		extends RelativeLayout
{
	...
	public PsnFriendListItem(Context context)
	{
		super(context);
	}
	
	public PsnFriendListItem(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}
	
	public PsnFriendListItem(Context context, AttributeSet attrs, int defStyle)
	{
