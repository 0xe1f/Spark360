...
public class SentMessageView extends RibbonedSinglePaneActivity
{
	@Override
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if ((titleFrag = (SentMessageViewFragment)fm.findFragmentByTag("details")) == null)
		{
			titleFrag = SentMessageViewFragment.newInstance(mAccount, titleId);
